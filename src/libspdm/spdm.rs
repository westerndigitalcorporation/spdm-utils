...
/// change.
macro_rules! create_libspdm_signature_test {
    ($test_name:ident, $mod_name:ident, $return_type:ty) => {
        #[cfg(test)]
        #[allow(dead_code)]
        fn $test_name(local: bool) -> $return_type {
            if local {
                $mod_name
            } else {
                libspdm_rs::$mod_name
...
create_libspdm_signature_test!(
    test_libspdm_requester_data_sign,
...
create_libspdm_signature_test!(
    test_libspdm_write_certificate_to_nvm_args,
...
create_libspdm_signature_test!(
    test_libspdm_generate_measurement_summary_hash,
    libspdm_generate_measurement_summary_hash,
    unsafe extern "C" fn(libspdm_rs::spdm_version_number_t, u32, u8, u32, u8, *mut u8, u32) -> bool
);
...
create_libspdm_signature_test!(
    test_libspdm_measurement_collection,
...
create_libspdm_signature_test!(
    test_libspdm_psk_handshake_secret_hkdf_expand,
...
create_libspdm_signature_test!(
    test_libspdm_psk_master_secret_hkdf_expand,
...
create_libspdm_signature_test!(
    test_libspdm_measurement_opaque_data,
...
create_libspdm_signature_test!(
    test_libspdm_challenge_opaque_data,
...
create_libspdm_signature_test!(
    test_libspdm_encap_challenge_opaque_data,
...
create_libspdm_signature_test!(
    test_libspdm_is_in_trusted_environment,
